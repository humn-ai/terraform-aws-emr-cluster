...
|------|-------------|------|---------|:-----:|
| additional\_ec2\_role\_policy\_config | (Optional) - A list of policy objects be created and added to the EMR EC2 Role | <code><pre>list(object({<br>    name        = string<br>    description = string<br>    path        = string<br>    policy      = string<br>  }))<br></pre></code> | n/a | yes |
